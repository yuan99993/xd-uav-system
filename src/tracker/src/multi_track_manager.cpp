...
bool normalizedBox(const tracker::DetectionCandidate& candidate,
...
struct PreparedDetection {
  tracker::DetectionCandidate message;
  NormalizedBox box;
...
struct PersistentTrack {
  ...
  tracker::DetectionCandidate latest_detection;
...
ManagedDetectionFrame MultiTrackManager::update(
    const tracker::DetectionArray& detections, const int image_width,
...
bool MultiTrackManager::latestCandidate(
    const int track_id, tracker::DetectionCandidate* candidate,

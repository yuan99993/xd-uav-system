...
# catkin_install_python executes this source through a devel-space wrapper.
# Prefer the real source directory so the wrapper with the same module name
# cannot shadow the sibling helper.

...
class IntegrationNodesTest(unittest.TestCase):
    def setUp(self):
        self._canonical = []
    ...
    def test_explicit_owner_and_fail_closed_health(self):
        ...
        response = rospy.ServiceProxy(
            "/uav1/reference_mux/select_ego", SetBool)(True)
...
if __name__ == "__main__":
    rospy.init_node("test_integration_nodes")
    import rostest
    rostest.rosrun("xd_uav_system_integration", "test_integration_nodes",
                   IntegrationNodesTest)

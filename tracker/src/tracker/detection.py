"""
NormalizedDetection — backend-agnostic detection record.

Ported from PixEagle src/classes/detection_adapter.py
...
class NormalizedDetection:
    """Unified detection record consumed by tracker internals."""
